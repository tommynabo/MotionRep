...
4. Tempo: use EXACTLY "1.5s eccentric lowering, 0.25s pause at bottom, 1s concentric drive, 0.25s lockout hold" per repetition (3s/rep × 4 reps = 12s total — fits exactly within the 12s video).
